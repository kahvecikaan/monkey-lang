...
type (
	...
	infixParseFn  func(ast.Expression) ast.Expression // arg: left side of infix operator that's being parsed
)
...
func (p *Parser) ParseProgram() *ast.Program {
	// Construct the root node of the AST, which is *ast.Program
	program := &ast.Program{}
...
// Refactored into a more general function, which is parseExpressionList
